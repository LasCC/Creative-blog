                            ...
                            <tr>
                                ...
                                <th>
                                    <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Edit">
                                        <a href="edit_posts.php?id=<?php echo $post["id"]; ?>" style="text-decoration: none">
                                    ...
                                    <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Delete">
                                        <a href="edit_posts.php?delete_id=<?php echo $post["id"]; ?>" style="text-decoration: none">
                                    ...
                                    <a href="edit_posts.php?published=0&p_id=<?php echo $post["id"] ?>">
                                        <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Unpublish">
                                            <i class="uil uil-times" style="font-size: 25px; cursor: pointer; color: orange"></i>
                                        </button>
                                    </a>
                                    <?php else: ?>
                                    <a href="edit_posts.php?published=1&p_id=<?php echo $post["id"] ?>">
                                        <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Publish">
                                            <i class="uil uil-check" style="font-size: 25px; cursor: pointer; color: orange"></i>
                                        </button>
                                    </a>
                                    <?php endif; ?>
                                </th>
