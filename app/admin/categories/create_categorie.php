                ...
                <div class="mt-5">
                    <form action="create_categorie.php" method="post">
                        <div class="form-group">
                            ...
                            <input value="<?php echo $name; ?>" name="name" type="text" class="form-control" id="exampleInputEmail1" />
                        ...
                        <button name="add-categorie" type="submit" class="btn mr-2" style="background-color: #3941FF; color: white; padding: 15px; font-weight: bold; margin-top: 15px">
                            Add the categorie
                        </button>
                    </form>
                </div>
