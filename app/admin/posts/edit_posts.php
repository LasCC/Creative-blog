...
<head>
    ...
    <title>Creative Blog - Edit posts</title>
</head>
                ...
                <div class="mt-5">
                    <form action="edit_posts.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="body" class="form-control" id="exampleTextarea"
                                rows="5"><?php echo $body; ?></textarea>
                        </div>
                        ...
                        <div class="form-group mt-5">
                            ...
                            <select class="form-control" id="selectForm" name="categorie_id">
                                ...
                                <option selected value="<?php echo $categorie["id"]; ?>">
                        ...
                        <button name="update-post" type="submit" class="btn mr-2"
