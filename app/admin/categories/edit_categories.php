...
<head>
    ...
    <title>Creative Blog - Edit categories section</title>
</head>
                ...
                <div class="mt-5">
                    <form action="edit_categories.php" method="post">
                        <div class="form-group">
                            <input name="id" value="<?php echo $id; ?>" type="hidden" class="form-control" id="exampleInputEmail1" />
                            <label for="exampleInputEmail1">Name of the categorie</label>
                            <input name="name" value="<?php echo $name; ?>" type="text" class="form-control" id="exampleInputEmail1" />
