...
<head>
    ...
    <title>Creative Blog - Edit users</title>
</head>
                ...
                <div class="mt-5">
                    <form class="mt-4" action="edit_users.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo $email ?>" name="email" type="text" class="form-control" id="exampleInputEmail2" placeholder="Email" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="custom-control custom-checkbox mt-3 mb-4">
                            ...
                            <?php else: ?>
                            <input name="admin" type="checkbox" class="custom-control-input" id="customCheck1" />
                            <label class="custom-control-label" for="customCheck1">Admin user ?</label>
                            <? endif; ?>
                        </div>
                        <button name="update-user" type="submit" class="btn mr-2" style="background-color: #006cff; color: white; padding: 15px; font-weight: bold; margin-top: 15px">
                            Update the user
                        </button>
                    </form>
                </div>
