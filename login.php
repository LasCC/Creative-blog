...
<body>
    <div class="alignContent container">
        <div style="background-color: #3941FF; height: auto; width: 50%; padding: 55px">
            ...
            <form class="mt-4" action="login.php" method="post">
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text" style="color: #f6f6f6">Never share your credentials to anyone else.</small>
                </div>
                <div class="form-group">
                ...
                <button name="loginBtn" type="submit" class="btn btn-raised mt-4" style="width: 100%; color: #3941FF; background-color: white; font-weight: bold;">
                    Login
                </button>
                <p style="color: #f6f6f6; font-size: 15px" class="mt-3 text-center">
                    You don't have any account ?
                    <a href="<?php echo BASE_URL . 'register.php' ?>" style="color: white; font-weight: bold">Register</a>
                </p>
            </form>
        </div>
