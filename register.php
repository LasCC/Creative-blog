  ...
  <body>
    <div class="alignContent container">
      <div style="height: 80%; width: 50%; padding: 25px">
        <img
          src="https://svgur.com/i/HLv.svg"
          style="height: 120%; position: relative; right: 425px; z-index: 1;"
          alt=""
        />
      </div>
      <div
        style="background-color: #3941FF; height: auto; width: 50%; padding: 55px;z-index: 2;"
      >
        <img
          class="mb-3"
        ...
        <form class="mt-4" action="register.php" method="post">
          ...
          <p style="color: #f6f6f6; font-size: 15px" class="mt-3 text-center">
            ...
            <a href="<?php echo BASE_URL . 'login.php' ?>" style="color: white; font-weight: bold"
              >Login</a
            >
          </p>
        </form>
